...
static constexpr auto qt_meta_stringdata_ZN12ClientWorkerE = QtMocHelpers::stringData(
    "ClientWorker",
    "finished",
    "",
    "disconnected",
...
Q_CONSTINIT static const uint qt_meta_data_ZN12ClientWorkerE[] = {
...
Q_CONSTINIT const QMetaObject ClientWorker::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN12ClientWorkerE.offsetsAndSizes,
    qt_meta_data_ZN12ClientWorkerE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN12ClientWorkerE_t,
        // Q_OBJECT / Q_GADGET
...
void ClientWorker::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        {
            using _q_method_type = void (ClientWorker::*)();
            if (_q_method_type _q_method = &ClientWorker::finished; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _q_method_type = void (ClientWorker::*)();
            if (_q_method_type _q_method = &ClientWorker::disconnected; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
        {
            using _q_method_type = void (ClientWorker::*)(const QString & );
            if (_q_method_type _q_method = &ClientWorker::dataReceived; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 2;
                return;
            }
        }
...
void *ClientWorker::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN12ClientWorkerE.stringdata0))
